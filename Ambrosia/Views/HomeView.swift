...
struct HomeView: View {
    ...
    @State var newRestaurantModel: NewRestaurantModel = NewRestaurantModel()
    ...
    var body: some View {
        ...
        VStack {
            Button("Button title") {
                newRestaurantModel.fetchRestaurant()
            }
...
//            }
        ...
        }.onAppear(perform: newRestaurantModel.fetchRestaurant)
