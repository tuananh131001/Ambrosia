...
class UserModel: ObservableObject {
    ...
    // MARK: save current login to local storage (normal method)
    ...
    // MARK: save current login to local storage (microsoft method)
    ...
    // MARK: authenticate user when using google
